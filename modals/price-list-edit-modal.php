                ...
                <div class="modal-content">
                    <form data-json-form data-endpoint="../api/update-price-list.php" data-success-message="Article updated successfully.">
                        <div class="modal-header">
                            <h2 class="modal-title fs-5" id="editPriceListModalLabel-<?php echo (int)($article['id'] ?? 0); ?>">Edit Article</h2>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label" for="article-label-<?php echo (int)($article['id'] ?? 0); ?>">Label</label>
                                    <input
                                        class="form-control"
                                        type="text"
                                ...
                                <div class="col-md-6">
                                    <label class="form-label" for="article-price-<?php echo (int)($article['id'] ?? 0); ?>">Retail Price</label>
                                    <input
                                        class="form-control"
                                        type="number"
                                ...
                                <div class="col-md-6">
                                    <label class="form-label" for="article-vat-<?php echo (int)($article['id'] ?? 0); ?>">VAT Rate</label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label" for="article-unit-<?php echo (int)($article['id'] ?? 0); ?>">Unit</label>
